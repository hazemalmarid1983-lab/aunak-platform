 ...
 * Specialist dashboard — fetch students linked via assigned_specialist (runtime Tawasul base/table).
 */
...
import { resolveSpecialistCaseload } from '../../../src/lib/specialistIsolation.js';
...
export default async function handler(req, res) {
  ...
  try {
    if (!specialistRecordId && specialistToken) {
      ...
      const specialist = await findSpecialistByToken(
        apiKey,
        baseId,
        specialistsTable,
        specialistToken
