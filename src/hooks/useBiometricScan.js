...
export function useBiometricScan({
  ...
  const messages = {
    ar: {
      errorCamera: "فشل في التعرف - الكاميرا مغلقة أو المستفيد غير مسجل",
      errorModel: "فشل تحميل نماذج التعرف من /models — حدّث الصفحة وأعد المحاولة.",
      errorRegistryEmpty: "لا توجد سجلات مستفيدين في Airtable",
      errorNoBiometric: "لا توجد بصمات وجه مسجلة",
      errorTimeout: "انتهت مهلة المسح دون مطابقة سيادية",
      errorPermission: "صلاحية الكاميرا غير مفعلة لهذا المستفيد",
      errorMatch: "لم تتحقق عتبة الثقة السيادية (94.7%)",
      errorMismatch: "بصمة الوجه لا تطابق اللقطة المرجعية — أعد المحاولة",
      errorDuplicate: "رفض — الوجه مسجّل لمستفيد آخر. تم حظر العملية.",
      errorEnrollmentTimeout: "انتهت مهلة التحقق — تأكد من الإضاءة وواجه الكاميرا ثم أعد المحاولة",
      errorNoSelection: "اختر اسم المستفيد أولاً قبل المسح البيومتري",
      errorStatusBlocked: "حالة المستفيد غير نشطة — تواصل مع المركز",
      referenceCapture: "جاري التقاط اللقطة المرجعية الأولى وحفظها...",
      referenceCaptureFailed: "تعذر حفظ اللقطة المرجعية — أعد المحاولة",
    },
    en: {
      errorCamera: "Recognition failed — camera closed or beneficiary not registered",
      errorModel: "Failed to load face models from /models — refresh and retry.",
      errorRegistryEmpty: "No beneficiary records in Airtable",
      errorNoBiometric: "No enrolled face biometrics",
      errorTimeout: "Scan timed out without sovereign match",
      errorPermission: "Camera permission is not active for this beneficiary",
      errorMatch: "Sovereign confidence threshold (94.7%) not met",
      errorMismatch: "Face does not match the reference capture — try again",
      errorDuplicate: "Denied — face already registered to another beneficiary. Blocked.",
      errorEnrollmentTimeout: "Verification timed out — face the camera with good lighting and retry",
      errorNoSelection: "Select a beneficiary name before starting the biometric scan",
      errorStatusBlocked: "Beneficiary status inactive — contact the center",
