...
export default function AunakSessionRegistry({ lang = "ar" }) {
  ...
  const t = {
    ar: {
      ...
      specialistClaims: "مطالبات المعالج السلوكي",
      ...
      biometricRequired: "اعتراض مالي: محرك AUN-4611 لم يثبت حضور المستفيد بيومترية حية",
    },
    en: {
      title: "ABC Sessional Mapping",
      ...
      specialistClaims: "Behavior Therapist Claims",
      ...
      biometricRequired: "Financial intercept: AUN-4611 engine did not verify live beneficiary biometric presence",
    },
  };
