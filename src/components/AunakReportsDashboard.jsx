...
export default function AunakReportsDashboard({ lang = 'ar' }) {
  ...
  const t = {
    ar: {
      ...
      weekly: 'أسبوعي',
      monthly: 'شهري',
      student: 'اسم المستفيد',
      selectStudent: 'اختر المستفيد',
      ...
      parentLocked: 'تقرير المستفيد المرتبط بحسابكم',
      sessions: 'جلسة مختومة',
      specialists: 'المعالجون السلوكيون',
    ...
    en: {
      ...
      selectStudent: 'Select beneficiary',
      ...
      parentLocked: 'Report for your linked beneficiary',
      sessions: 'sealed session(s)',
      specialists: 'Behavior Therapists',
