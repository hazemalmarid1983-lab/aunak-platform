...
export default function AunakActivationGate({
  ...
  const t = {
    ar: {
      title: 'بوابة تفعيل الرخص الاستشارية والمساندة',
      subtitle: 'أدخل رمز تفعيل الرخصة الذي منحته الإدارة بعد السداد',
      student: 'المستفيد',
      placeholder: 'AUN-TUTOR-XXXX-2026',
      activate: 'تعميد وتفعيل الرخصة',
      activating: 'جاري التعميد...',
      success: 'تم التعميد — حالة الرخصة Active',
      invalid: 'رمز غير صالح أو منتهي',
      hint: 'FREE · TUTOR · MEDICAL · INST · ASSESS',
      enterGate: 'الدخول للبوابة المفضلة',
      valueLock: 'Value Lock — الوصول مقفل حتى تفعيل الرخصة',
      pendingNote: 'حسابك في انتظار تفعيل الرخصة الاستشارية',
      expiredNote: 'انتهت رخصتك — أدخل رمزاً جديداً للتجديد',
      formatHint: 'الصيغة: AUN-{PLAN}-XXXX-YYYY',
      assessNote: 'رخصة ASSESS تفتح مقياس المسح النمائي المعزول فقط',
      enterBiometric: 'متابعة تسجيل البصمة (بعد تفعيل الرخصة)',
      orPay: 'أو تفعيل الرخصة عبر السداد الإلكتروني الآمن',
      manualCode: 'رمز تفعيل الرخصة الاستشارية',
      tripleTitle: 'بوابات السيادة الثلاث — احفظ روابط الأجهزة',
    },
    en: {
      title: 'Consultative License Activation Gate',
      subtitle: 'Enter the license activation code issued by admin after payment',
      student: 'Beneficiary',
      placeholder: 'AUN-TUTOR-XXXX-2026',
      activate: 'Seal & Activate License',
      activating: 'Sealing...',
      success: 'Sealed — license Active',
      invalid: 'Invalid or expired code',
      hint: 'FREE · TUTOR · MEDICAL · INST · ASSESS',
      enterGate: 'Enter preferred portal',
      valueLock: 'Value Lock — access blocked until license activation',
      pendingNote: 'Your account is pending license activation',
      expiredNote: 'License expired — enter a renewal code',
      formatHint: 'Format: AUN-{PLAN}-XXXX-YYYY',
      assessNote: 'ASSESS license opens isolated Developmental Screening Matrix only',
      enterBiometric: 'Continue to biometric enrollment (post-license)',
      orPay: 'Or activate license via secure online payment',
      manualCode: 'Manual consultative license code',
