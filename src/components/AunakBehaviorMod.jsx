...
export default function AunakBehaviorMod({ lang = 'ar' }) {
  ...
  const t = {
    ar: {
      ...
      targetStudent: 'الحالة المستهدفة:',
      ...
      strategyPlaceholder: 'أدخل استراتيجيات التدخل وملاحظات توثيق مصفوفة ABC هنا...',
    ...
    en: {
      ...
      strategyPlaceholder: 'Enter intervention strategies and ABC sessional mapping notes here...',
